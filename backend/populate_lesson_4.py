...
def populate_dialogues(cursor):
    dialogues = [
        ...
        ("n_l4_v1_greet",       "d_l4_v1_001",
         "Hello!", "老板好！", "audio-clips/n_l4_v1_greet.wav", "npc_bubble_tea"),

        ("n_l4_v1_menu",        "d_l4_v1_002",
         "Welcome! What would you like?",
         "欢迎！你要什么？", "audio-clips/n_l4_v1_menu.wav", "", "npc_bubble_tea"),

        ("n_l4_v1_size_ask",    "d_l4_v1_003",
         "I would like a bubble tea please. What sizes do you have?",
         "我要一杯珍珠奶茶。请问有什么size？", "audio-clips/n_l4_v1_size_ask.wav", "npc_bubble_tea"),

        ("n_l4_v1_large",       "d_l4_v1_004",
         "Large please!",
         "大杯！", "audio-clips/n_l4_v1_large.wav", "npc_bubble_tea"),

        ("n_l4_v1_medium",      "d_l4_v1_005",
         "Medium please!",
         "中杯！", "audio-clips/n_l4_v1_medium.wav", "npc_bubble_tea"),

        ("n_l4_v1_small",       "d_l4_v1_006",
         "Small please!",
         "小杯！", "audio-clips/n_l4_v1_small.wav", "", "npc_bubble_tea"),

        ("n_l4_v1_sugar_ask",   "d_l4_v1_007",
         "What sugar level would you like?",
         "你要几分糖？", "audio-clips/n_l4_v1_sugar_ask.wav", "", "npc_bubble_tea"),

        ("n_l4_v1_no_sugar",    "d_l4_v1_008",
         "No sugar please!",
         "无糖！", "audio-clips/n_l4_v1_no_sugar.wav", "npc_bubble_tea"),

        ("n_l4_v1_30_sugar",    "d_l4_v1_009",
         "30% sugar please!",
         "三分糖！", "audio-clips/n_l4_v1_30_sugar.wav", "npc_bubble_tea"),

        ("n_l4_v1_50_sugar",    "d_l4_v1_010",
         "Half sugar please!",
         "半糖！", "audio-clips/n_l4_v1_50_sugar.wav", "npc_bubble_tea"),

        ("n_l4_v1_70_sugar",    "d_l4_v1_011",
         "70% sugar please!",
         "七分糖！", "audio-clips/n_l4_v1_70_sugar.wav", "npc_bubble_tea"),

        ("n_l4_v1_100_sugar",   "d_l4_v1_012",
         "Full sugar please!",
         "全糖！", "audio-clips/n_l4_v1_100_sugar.wav", "npc_bubble_tea"),

        ("n_l4_v1_ice_ask",     "d_l4_v1_013",
         "What ice level would you like?",
         "你要几分冰？", "audio-clips/n_l4_v1_ice_ask.wav", "npc_bubble_tea"),

        ("n_l4_v1_no_ice",      "d_l4_v1_014",
         "No ice please!",
         "去冰！", "audio-clips/n_l4_v1_no_ice.wav", "npc_bubble_tea"),

        ("n_l4_v1_less_ice",    "d_l4_v1_015",
         "Less ice please!",
         "少冰！", "audio-clips/n_l4_v1_less_ice.wav", "npc_bubble_tea"),

        ("n_l4_v1_normal_ice",  "d_l4_v1_016",
         "Normal ice please!",
         "正常冰！", "audio-clips/n_l4_v1_normal_ice.wav", "npc_bubble_tea"),

        ("n_l4_v1_extra_ice",   "d_l4_v1_017",
         "Extra ice please!",
         "多冰！", "audio-clips/n_l4_v1_extra_ice.wav", "npc_bubble_tea"),

        ("n_l4_v1_topping_ask", "d_l4_v1_018",
         "Which topping would you like?",
         "你要加什么料？", "audio-clips/n_l4_v1_topping_ask.wav", "npc_bubble_tea"),

        ("n_l4_v1_pearl",       "d_l4_v1_019",
         "Tapioca pearls please!",
         "加珍珠！", "audio-clips/n_l4_v1_pearl.wav", "npc_bubble_tea"),

        ("n_l4_v1_coconut",     "d_l4_v1_020",
         "Coconut jelly please!",
         "加椰果！", "audio-clips/n_l4_v1_coconut.wav", "npc_bubble_tea"),

        ("n_l4_v1_red_bean",    "d_l4_v1_021",
         "Red bean please!",
         "加红豆！", "audio-clips/n_l4_v1_red_bean.wav", "npc_bubble_tea"),

        ("n_l4_v1_no_topping",  "d_l4_v1_022",
         "No toppings please!",
         "不要加料！", "audio-clips/n_l4_v1_no_topping.wav", "npc_bubble_tea"),

        ("n_l4_v1_complete",    "d_l4_v1_023",
         "Coming right up! Here is your bubble tea!",
         "好的！你的珍珠奶茶来了！", "audio-clips/n_l4_v1_complete.wav", "npc_bubble_tea"),

        # Path 2: 豆花 Tofu
        ("n_l4_v2_greet",       "d_l4_v2_001",
         "Hello!", "老板好！", "audio-clips/n_l4_v2_greet.wav", "npc_tofu"),

        ("n_l4_v2_explain",     "d_l4_v2_002",
         "Welcome! Our tofu pudding is very smooth today! "
         "Which topping would you like?",
         "欢迎！我们今天的豆花很嫩！你要加什么料？",
         "audio-clips/n_l4_v2_explain.wav", "npc_tofu"),

        ("n_l4_v2_topping_ask", "d_l4_v2_003",
         "We have red bean, taro, peanut, and grass jelly!",
         "我们有红豆、芋头、花生还有仙草！",
         "audio-clips/n_l4_v2_topping_ask.wav", "npc_tofu"),

        ("n_l4_v2_red_bean",    "d_l4_v2_004",
         "Red bean please! And add more syrup!",
         "加红豆！然后多放一点糖水！", "audio-clips/n_l4_v2_red_bean.wav", "npc_tofu"),

        ("n_l4_v2_taro",        "d_l4_v2_005",
         "Taro please! And less syrup!",
         "加芋头！然后少放点糖水！", "audio-clips/n_l4_v2_taro.wav", "npc_tofu"),

        ("n_l4_v2_peanut",      "d_l4_v2_006",
         "Peanut please!",
         "加花生！", "audio-clips/n_l4_v2_peanut.wav", "npc_tofu"),

        ("n_l4_v2_grass_jelly", "d_l4_v2_007",
         "Grass jelly please!",
         "加仙草！", "audio-clips/n_l4_v2_grass_jelly.wav", "npc_tofu"),

        ("n_l4_v2_adjust_ask",  "d_l4_v2_008",
         "Would you like more or less syrup?",
         "糖水要多一点还是少一点？", "audio-clips/n_l4_v2_adjust_ask.wav", "", "npc_tofu"),

        ("n_l4_v2_more_syrup",  "d_l4_v2_009",
         "More syrup please!",
         "多放一点！", "audio-clips/n_l4_v2_more_syrup.wav", "npc_tofu"),

        ("n_l4_v2_less_syrup",  "d_l4_v2_010",
         "Less syrup please!",
         "少放点！", "audio-clips/n_l4_v2_less_syrup.wav", "npc_tofu"),

        ("n_l4_v2_fine",        "d_l4_v2_011",
         "It is perfect as it is, thank you!",
         "这样就好了，谢谢！", "audio-clips/n_l4_v2_fine.wav", "npc_tofu"),

        ("n_l4_v2_complete",    "d_l4_v2_012",
         "Here you go! Enjoy your tofu pudding!",
         "来！请慢用！", "audio-clips/n_l4_v2_complete.wav", "npc_tofu"),

        # Path 3: 剉冰 Shaved Ice
        ("n_l4_v3_greet",       "d_l4_v3_001",
         "Hello!", "老板好！", "audio-clips/n_l4_v3_greet.wav", "npc_shaved_ice"),

        ("n_l4_v3_explain",     "d_l4_v3_002",
         "Welcome! Our shaved ice is very refreshing! "
         "What toppings would you like?",
         "欢迎！我们的剉冰很消暑！你要加什么料？",
         "audio-clips/n_l4_v3_explain.wav", "npc_shaved_ice"),

        ("n_l4_v3_topping_ask", "d_l4_v3_003",
         "We have taro balls, red bean, and mung bean!",
         "我们有芋圆、红豆还有绿豆！",
         "audio-clips/n_l4_v3_topping_ask.wav", "npc_shaved_ice"),

        ("n_l4_v3_taro_ball",   "d_l4_v3_004",
         "Taro balls please!",
         "加芋圆！", "audio-clips/n_l4_v3_taro_ball.wav", "npc_shaved_ice"),

        ("n_l4_v3_red_bean",    "d_l4_v3_005",
         "Red bean please!",
         "加红豆！", "audio-clips/n_l4_v3_red_bean.wav", "npc_shaved_ice"),

        ("n_l4_v3_mung_bean",   "d_l4_v3_006",
         "Mung bean please!",
         "加绿豆！", "audio-clips/n_l4_v3_mung_bean.wav", "npc_shaved_ice"),

        ("n_l4_v3_syrup_ask",   "d_l4_v3_007",
         "How much syrup would you like?",
         "你要加多少糖水？", "audio-clips/n_l4_v3_syrup_ask.wav", "npc_shaved_ice"),

        ("n_l4_v3_no_sugar",    "d_l4_v3_008",
         "No syrup please!",
         "不要糖水！", "audio-clips/n_l4_v3_no_sugar.wav", "npc_shaved_ice"),

        ("n_l4_v3_half_sugar",  "d_l4_v3_009",
         "Half syrup please!",
         "半糖！", "audio-clips/n_l4_v3_half_sugar.wav", "npc_shaved_ice"),

        ("n_l4_v3_full_sugar",  "d_l4_v3_010",
         "Full syrup please!",
         "全糖！", "audio-clips/n_l4_v3_full_sugar.wav", "npc_shaved_ice"),

        ("n_l4_v3_complete",    "d_l4_v3_011",
         "Here you go! Stay cool!",
         "来！消暑一下！", "audio-clips/n_l4_v3_complete.wav", "npc_shaved_ice"),
    ]
